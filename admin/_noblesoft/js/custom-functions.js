    ...
    function properticonfirmDelete(delUrl) {
        if (confirm("Once this property is deleted you will have to resubscribe to get back on the site and all subscriptions are non refundable")) {
            document.location = delUrl;
        }
    }
