							...
							<div class="login-account p-30 checkbox-custom">    
								...
								<div class="checkbox">
									...
									<label for="drop-remove2">
										...
										I have agree with all <a href="{{url('pages/terms-and-conditions')}}">terms &amp; conditions</a>
    ...
    $.ajax({
...

           {
...

               {
               		...
               		alert("Your account is created successfully. Please check your email address and verify your account.please check your email junk box if not received in inbox");
