...
if (Auth::check() && Auth::user()->role == 'owner') {
    if (isset($_GET['pid'])) {
        ?>
                                    ...
                                    <form action="{{url()}}/stripe/charge.php" method="POST" id="firstform" style="display: none;">
                                        <input type="hidden" name="pid" id="pid" value="<?php if (isset($_GET['pid'])) {
            echo $_GET['pid'];
        } ?>">
        <?php if (isset($_COOKIE['user_currency'])) { ?>
                                            <input type="hidden" name="pckg_amount" id="pckg_amount" value="<?php echo EnvatoUser::calculateCurrency('USD', $_COOKIE['user_currency'], 59); ?>">
                                            ...
                                            <script
                                                ...
                                                data-currency="<?php echo $_COOKIE['user_currency']; ?>"
                                                data-description="/ Month per listing + taxes (<?php echo $_COOKIE['user_currency']; ?>-4.15)"
                                                data-amount="<?php echo EnvatoUser::calculateCurrency('USD', $_COOKIE['user_currency'], 5900); ?>">
                                            </script>
        <?php } else { ?>	
                                            ...
                                            <script
                                                ...
                                                data-name="MatchPropertyDirect™"
                                                data-currency="USD"
                                                data-description="/ Month per listing + taxes (USD-4.15)"
                                                data-amount="6315">
                                            </script>
                                    <?php } ?>
    ...
    <?php } else { ?>
                    ...
                    <div class="pricingWrap">
                        ...
                        <div class="aboutPackage">
                            <?php if (isset($_COOKIE['user_currency'])) { ?>
                                <p class="pricing"><?php echo $_COOKIE['currency_symbol'] . ' ' . EnvatoUser::calculateCurrency('USD', $_COOKIE['user_currency'], 159); ?></p>
<?php } else { ?>
...
if (Auth::check() && Auth::user()->role == 'owner') {
    if (isset($_GET['pid'])) {
        ...
        <?php if (isset($_COOKIE['user_currency'])) { ?>
                                            <input type="hidden" name="pckg_amount" id="pckg_amount" value="<?php echo EnvatoUser::calculateCurrency('USD', $_COOKIE['user_currency'], 15900); ?>">
                                            ...
                                            <script
                                                ...
                                                data-name="MatchPropertyDirect™"
                                                data-currency="<?php echo $_COOKIE['user_currency']; ?>"
                                                data-description="/ 6 month per listing + taxes (<?php echo $_COOKIE['user_currency']; ?>-11.15)"
                                                data-amount="<?php echo EnvatoUser::calculateCurrency('USD', $_COOKIE['user_currency'], 15900); ?>">
                                            </script>
        <?php } else { ?>	
                                            ...
                                            <script
                                                ...
                                                data-name="MatchPropertyDirect™"
                                                data-currency="USD"
                                                data-description="/ 6 month per listing + taxes (USD-11.15)"
                                                data-amount="15900">
                                            </script>
        <?php } ?>
                    ...
                    <div class="pricingWrap">
                        ...
                        <div class="aboutPackage">
<?php if (isset($_COOKIE['user_currency'])) { ?>
                                <p class="pricing"><?php echo $_COOKIE['currency_symbol'] . ' ' . EnvatoUser::calculateCurrency('USD', $_COOKIE['user_currency'], 259); ?></p>
<?php } else { ?>
...
<?php } ?>
        ...
        <?php if (isset($_COOKIE['user_currency'])) { ?>
                                            <input type="hidden" name="pckg_amount" id="pckg_amount" value="<?php echo EnvatoUser::calculateCurrency('USD', $_COOKIE['user_currency'], 25900); ?>">
                                            <input type="hidden" name="pckg_month" id="pckg_month" value="12month">
                                            <input type="hidden" name="pckg_decp" id="pckg_decp" value="/ Year per listing + taxes (<?php echo $_COOKIE['user_currency']; ?>-18.15)">
                                            <script
                                                src="https://checkout.stripe.com/checkout.js" class="stripe-button"
                                                data-key="pk_live_iZpQyPmqoLJMWm4Egewp3PX8"
                                                data-image="{{url()}}/img/site-logo-default-dark.png"
                                                ...
                                                data-amount="<?php echo EnvatoUser::calculateCurrency('USD', $_COOKIE['user_currency'], 25900); ?>">
                                            </script>
        <?php } else { ?>
                                            ...
                                            <script
                                                ...
                                                data-name="MatchPropertyDirect™"
                                                data-currency="USD"
                                                data-description=" Year per listing + taxes (USD-18.15)"
                                                data-amount="25900">
                                            </script>
        <?php } ?>
