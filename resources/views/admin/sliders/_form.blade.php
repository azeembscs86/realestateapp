...
<div class="form-group">
  ...
  <label class="col-sm-3 col-xs-12 control-label">Short Description</label>
  ...
  <div class="col-sm-9 col-xs-12">
    ...
    <input 
      ...
      value="@if(old('sliderdescp')){!! old('sliderdescp') !!}@elseif(isset($slider->sliderdescp)){!!$slider->sliderdescp!!}@endif"
