...
<input name="citylatitude" type="hidden" id="citylatitude" class="form-control"    value="
...
<input name="citylongitude" type="hidden" id="citylongitude" class="form-control"  value="@if(old('longitude')){!! old('longitude') !!}@elseif(isset($property->longitude)){!!$property->longitude!!}@endif"/>
...
<div class="area-acre-error" style="display:none;">
    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
          ...
          <input type="text" name="city" id="city" class="form-control" placeholder="Enter a Location" required="" value="@if(old('city')){!! old('city') !!}@elseif(isset($property->city)){!!$property->city!!}@endif">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
         <select name="country_name" required="required" id="country_name" class="form-control">
  ...
  <fieldset class="checkbox">
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 index-control featured-visible-hide" style="display:none;">
...
<div class="col-md-12">
  ...
  <fieldset>
    ...
    <div class="col-md-12">
      ...
      <div class="form-group attorney-fee" style="display:none">
