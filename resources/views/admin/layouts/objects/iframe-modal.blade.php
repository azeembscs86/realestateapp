<style type="text/css">
.main-property-pop .btn.btn-primary.btn-iframe-submit{
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <button type="button" class="close ajax-form-close <?php if(substr(Route::getCurrentRoute()->getPath(), 0, 16) == 'admin/properties'){ echo 'drft'; }else{} ?>" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary btn-iframe-submit"><span class="glyphicon glyphicon-ok"></span> Save</button>
