...
<style type="text/css">
	...
	<div class="col-xs-12">
		...
		<?php if(isset($_COOKIE['user_currency'])){ ?>
	      <span class="price"><?php echo 'Asking Price: '.$_COOKIE['user_currency'].'-'.EnvatoUser::calculateCurrency($property->currency_code,$_COOKIE['user_currency'],$property->sale_price); ?></span>
	      <?php }else{ ?> 
