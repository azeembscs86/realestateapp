                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-custom clr_cstm">
                        ...
                        <input type="text" id="state_id" name="state_id" class="btn-group bootstrap-select" placeholder="Location"/>
                      </div>
                    <!--<div class="form-custom clr_cstm">
 ...
 <input id="amount2" name="max_area" type="number" min="100" class="form-control" placeholder="Max Area" />
                ...
                <div class="col-xs-12">
                    <div class="form-custom garages">
                      ...
                      <ul class="submenu pull-left" style="display: none;">
                          <li>
...
<script>
    ...
    /*  $(document).ready(function(){
      ...
      <h2 style="text-align: center">Sorry. No results Found for your search. If you want to be notified by email when this property is added <?php echo $searh_name; ?> <a class='inline' style="text-decoration: underline;" href="#"  data-toggle="modal" data-target="#notification">Click Here</a></h2>
...
<script>
  ...
  <script type="text/javascript">
   ...
   function initMap() {
    ...
    '<div id="siteNotice">'+
    '</div>'+
    '<img src="http://107.6.184.93/MatchPropertyDirect/'+properties[i]['propertyimage']+'" width="250" height="120"/>'+
    '<div id="bodyContent">'+'<a target="_blank" href="http://107.6.184.93/MatchPropertyDirect/show/'+properties[i]['slug']+'")}}><h4 id="firstHeading" class="firstHeading">'+properties[i]['title']+'</h4></a>' +
    '</div>'+
    '</div>'+
    '</div>';
