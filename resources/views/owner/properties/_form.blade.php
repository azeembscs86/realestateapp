<link rel="stylesheet" href="/admin/_noblesoft/cropper/assets/css/bootstrap.min.css">
<style type="text/css">
...
<input name="citylatitude" type="hidden" id="citylatitude" class="form-control"    value="39.23225"/>

<input name="citylongitude" type="hidden" id="citylongitude" class="form-control"  value="-101.77734"/>
    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
          ...
          <input name="bedrooms" type="number" required="required" min="1" max="50" class="form-control" 
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
          ...
          <input name="bathrooms" type="number" required="required" min="1" max="50" class="form-control" 
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
          ...
          <input name="address" type="text" required="required" id="address" class="form-control" 
      ...
      <div class="form-group">
        <label class="col-sm-4 col-xs-12 control-label">Area (Sq. Feet) </label>
        <div class="col-sm-8 col-xs-12">
          <input name="area" type="number" min="100" id="zip" class="form-control" 
      ...
      <div class="form-group">
        <label class="col-sm-4 col-xs-12 control-label">Acre </label>
        <div class="col-sm-8 col-xs-12">
          <input name="acre" type="text" id="acre" class="form-control" 
            value="@if(old('acre')){!! old('acre') !!}@elseif(isset($property->acre)){!!$property->acre!!}@endif"
            />
        </div>
      </div>
<div class=" area-acre-error" style="display:none; padding-left:10px;">
    <p style="color:#ff0404;">Please fill up atleast one field from Area (Sq. Feet) or Acre</p>
</div>
    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        ...
        <label class="col-sm-4 col-xs-12 control-label">Enter a location <!--<font color="#FF0000">*</font>--></label>

        <div class="col-sm-8 col-xs-12">

          <input type="text" name="city" id="city" class="form-control" placeholder="Enter a Location" value="@if(old('city')){!! old('city') !!}@elseif(isset($property->city)){!!$property->city!!}@endif" required>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
          ...
          <input name="zip" type="text" required="required" id="zip" class="form-control" 
      ...
      <div class="form-group">
        <label class="col-sm-4 col-xs-12 control-label">Country<font color="#FF0000">*</font></label>
        <div class="col-sm-8 col-xs-12">
         <select required name="country_name"  id="country_name" class="selectpicker form-control">
             <option>Select Country</option>
        @foreach( $countries as $country )
        <option value="{{$country->country_name}}" @if (isset($property->country_name) and ($country->country_name == $property->country_name)) selected="selected"  @endif>{{$country->country_name}}</option>                    
         @endforeach             
        </select>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
          ...
          <div class="input-group">
            ...
            <input name="latitude" type="hidden" id="latitude" class="form-control" 

              value="@if(old('latitude')){!! old('latitude') !!}@elseif(isset($property->latitude)){!!$property->latitude!!}@endif"

              />

            <input name="longitude" type="hidden" id="longitude" class="form-control" 
      ...
      <div class="form-group" style="display: none;">
       ...
       <div class="form-group" style="display:none;">
        ...
        <div class="col-sm-8 col-xs-12">
          ...
          <option value="<?php echo $sorting_arr[$j]; ?>" <?php if($property->year_built == $sorting_arr[$j]){ echo 'selected="selected"'; }else{} ?>><?php echo $sorting_arr[$j]; ?></option>
          <?php } ?>
     ...
     <div class="form-group">
            <div class="col-xs-12">
              ...
              <ul>
                ...
                <li><a href="{{url('')}}/pages/image-upload-process" target="_blank"> Click here to see instructions of how to upload photos of your properties</a></li>
              </ul>
            </div>
          </div>
  </fieldset>
    ...
    <legend>Price</legend>
            <div class="col-md-4 col-sm-6 col-xs-12">
              ...
              <div class="input-group"><!-- <span class="input-group-addon">$</span> -->
                ...
                <option value="GBP" <?php if(isset($property->currency_code) and ($property->currency_code == 'GBP')){ echo 'selected="selected"'; }else{} ?>>United Kingdom (£)</option>
                <option value="EUR" <?php if(isset($property->currency_code) and ($property->currency_code == 'EUR')){ echo 'selected="selected"'; }else{} ?>> Euro (€)</option>
                ...
                <option value="AUD" <?php if(isset($property->currency_code) and ($property->currency_code == 'AUD')){ echo 'selected="selected"'; }else{} ?>>Australian Dollar (AU$)</option>
                <option value="CAD" <?php if(isset($property->currency_code) and ($property->currency_code == 'CAD')){ echo 'selected="selected"'; }else{} ?>>Canadian Dollar (CA$)</option>
                <option value="JPY" <?php if(isset($property->currency_code) and ($property->currency_code == 'JPY')){ echo 'selected="selected"'; }else{} ?>>Japanese Yen (J¥)</option>
                <!--<option value="ZAR" <?php //if($property->currency_code == 'ZAR'){ //echo 'selected="selected"'; }else{} ?>>South African Rand (ZAR)</option>-->
                </select>
                </div>
            </div>
          </div>
  ...
  <fieldset>
    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
          <input name="att_name" type="text" class="form-control" required=""  
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
          <input name="att_email" type="email" class="form-control"  required="" 
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
          <input name="att_phone" type="text" class="form-control" required="" 
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
          <input name="att_address" type="text" class="form-control" required=""
    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
          <input name="att_pobox" type="text" class="form-control" 
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
          <input name="att_city" type="text" class="form-control" 
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
          <input name="att_state" type="text" class="form-control" 
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
          <input name="att_zipcode" type="text" class="form-control" 
...
<div class="col-md-12 margin-bottom-60">
  <fieldset>
    <legend>Subscribe to List your Property</legend>
    <div class="col-md-12">
    You are almost done uploading your property !
<br><br>
    Click "Subscribe to List your Property" below and select a subscription plan in order to make your uploaded property go live on Match Property Direct.
<br><br>
    You are One Step Away from Selling your Property ! Lets start the conversation. 
...
<div class="col-md-12 buttons-gap">   
    <button class="btn btn-primary prevBtn btn-lg" type="button" >Previous</button>
    <button class="btn btn-danger btn-lg" type="submit">Subscribe to List your Property</button>
</div>
</div>
...
$(document).ready(function () {
    ...
    allNextBtn.click(function(){
        ...
        var curStep = $(this).closest(".setup-content"),
            ...
            curInputs = curStep.find("input[type='text'],input[type='url'],input[type='number'],input[type='email'],select"),
            isValid = true;

        $(".form-group").removeClass("has-error");
        var scrollBool = true;
        for(var i=0; i<curInputs.length; i++){
            if($('[name="acre"]').val() == "" && $('[name="area"]').val() == ""){
                $(".area-acre-error").slideDown();
                isValid = false;
                $(".form-group").removeClass("has-error");
            }
            else{
                $(".area-acre-error").slideUp();
            }
            if($(curInputs[i]).attr("name") == "country_name" && $(curInputs[i]).val() == ""){
                isValid = false;
                ...
                if(scrollBool){
                    var body = $("html, body");
                    body.stop().animate({scrollTop:$(curInputs[i]).closest(".form-group").offset().top}, 500);
                   scrollBool = false; 
                }
                isValid = false;
                $(curInputs[i]).closest(".form-group").addClass("has-error");
        ...
        console.log($('select[name="country_name"]').val());
        if (isValid)
