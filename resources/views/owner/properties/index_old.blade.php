...
<div class="box">
  <div class="box-header">
    ...
    <a href="{{url('owner/properties/create')}}">Add Property</a>
    <button class="btn btn-success reload-page">
    <span class="glyphicon glyphicon-refresh"></span>
    </button>
<span style="margin-left: 10px;font-size: 16px;"><i class="fa fa-info-circle"></i><a href="http://107.6.184.93/MatchPropertyDirect/pages/image-upload-process" target="_blank"> click here to see instructions of how to upload photos of your properties</a></span>
  <style type="text/css">
  i.fa.fa-info-circle {
    font-size: 22px;
    color: #3b9dcc;
