    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
          ...
          <input name="bedrooms" type="number" required="required" min="0" max="20" class="form-control" 
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
          ...
          <input name="bathrooms" type="number" required="required" min="0" max="20" class="form-control" 
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
          ...
          <input name="area" type="number" required="required" min="100" max="60000" id="zip" class="form-control" 
     ...
     <div class="form-group">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
              <div class="input-group"><!-- <span class="input-group-addon">$</span> -->
                ...
                <option value="USD" <?php if($property->currency_code == 'USD'){ echo 'selected="selected"'; }else{} ?>>US Dollar ($)</option>
                <option value="GBP" <?php if($property->currency_code == 'GBP'){ echo 'selected="selected"'; }else{} ?>>United Kingdom (GBP)</option>
                <option value="EUR" <?php if($property->currency_code == 'EUR'){ echo 'selected="selected"'; }else{} ?>> Euro (EUR)</option>
                <option value="AED" <?php if($property->currency_code == 'AED'){ echo 'selected="selected"'; }else{} ?>>United Arab Emirates (AED)</option>
                <option value="AUD" <?php if($property->currency_code == 'AUD'){ echo 'selected="selected"'; }else{} ?>>Australian Dollar (AUD)</option>
                <option value="CAD" <?php if($property->currency_code == 'CAD'){ echo 'selected="selected"'; }else{} ?>>Canadian Dollar (CAD)</option>
                <option value="JPY" <?php if($property->currency_code == 'JPY'){ echo 'selected="selected"'; }else{} ?>>Japanese Yen (JPY)</option>
                <option value="SAR" <?php if($property->currency_code == 'SAR'){ echo 'selected="selected"'; }else{} ?>>Saudi Riyal (SAR)</option>
...
<div class="col-md-12 margin-bottom-60">
  <fieldset>
    ...
    <div class="col-md-12">
	Your almost done uploading your property !
<br><br>
...
<br><br>
	Your One Step Away from Selling your Property ! Lets start the conversation. 
